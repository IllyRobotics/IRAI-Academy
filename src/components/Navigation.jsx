    ...
    <nav className="fixed top-0 w-full bg-dark/95 backdrop-blur-md border-b border-white/10 z-50">
      <div className="container flex justify-between items-center h-20">
        ...
        <div className="hidden md:flex gap-8 items-center">
          <Link to="/#about" className="text-gray-400 hover:text-light transition-colors">About</Link>
          <Link to="/#features" className="text-gray-400 hover:text-light transition-colors">Features</Link>
          <Link to="/#courses" className="text-gray-400 hover:text-light transition-colors">Courses</Link>
